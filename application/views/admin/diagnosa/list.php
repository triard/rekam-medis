...
<body id="page-top" style="font-family: 'Roboto', sans-serif; background-color: #DEE1E2;">
    ...
    <div id="wrapper">
        ...
        <div id="content-wrapper">
                    ...
                    <div class="card-body">
                        <div class="card-header">
                            ...
                            <a class="btn btn-primary btn-sm"
                                href="<?php echo site_url('admin/diagnosa/list_masuk') ?>"><i class="fas fa-plus"></i>
                            Tambah Diagnosa</a>
                            <div class="float-lg-right">
                                ...
                                <?php $this->load->view("admin/diagnosa/_partials/_modal.php") ?>
                            </div>
                        </div>
                                    ...
                                    <tr>
                                        ...
                                        <td width="150" style="text-align: center;">
                                            ...
                                            <a class="btn btn-outline-danger btn-sm"
                                                href="<?php echo site_url('admin/diagnosa/delete/'.$r->id_diagnosa) ?>"
            ...
            <!-- Sticky Footer -->
            <?php $this->load->view("admin/diagnosa/_partials/edit.php") ?>
