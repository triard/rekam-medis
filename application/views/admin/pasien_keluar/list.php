...
<body id="page-top" style="font-family: 'Roboto', sans-serif; background-color: #DEE1E2;">
    ...
    <div id="wrapper">
        ...
        <div id="content-wrapper">
                    ...
                    <div class="card-body">
                        <div class="card-header">
                            <a class="btn btn-primary btn-sm"
                                href="<?php echo site_url('admin/pasien_keluar/list_masuk') ?>"><i
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            <center>
                                                <a href="<?php echo site_url('admin/pasien_keluar/konfirmasi/'.$r->id_nomor_ruangan) ?>"
                                        ...
                                        <td width="150" style="text-align: center;">
                                            ...
                                            <a class="btn btn-outline-danger btn-sm"
                                                href="<?php echo site_url('admin/pasien_keluar/delete/'.$r->id_pasien_keluar) ?>"
            ...
            <?php $this->load->view("admin/pasien_keluar/_partials/edit.php") ?>
