                ...
                <div class="card mb-3">
                    <div class="card-header">
                        ...
                        <a class="btn btn-warning btn-sm text-white"
                            href="<?php echo site_url('admin/pasien/list/') ?>"><i class="fas fa-arrow-left"></i>
                            Kembali</a>
                    </div>
                    <div class="card-body">
                        ...
                        <form action="" method="post" enctype="multipart/form-data">
							...
							<input type="hidden" name="bulan_buat" value="<?php echo $pasien->bulan_buat ?>" />
                            ...
                            <div class="form-group">
                                ...
                                <input class="form-control <?php echo form_error('no_KTP') ? 'is-invalid':'' ?>"
                                    type="text" name="no_KTP" placeholder="NOMOR KTP..." value="<?php echo $pasien->no_KTP ?>" maxlength="16" minlength="16"/>
                                <div class="invalid-feedback">
