                                    ...
                                    <div class="modal-body">
                                        <div class="float-lg-right m-4">
                                            <a class="btn btn-primary btn-sm m-1"
                                                href="<?php echo site_url('rekam_medis/pasien/laporan_pdfAll') ?>">Cetak Semua
                                                Data</a>
                                        </div>
                                        <div class="float-lg-right m-1">
                                            <form class="navbar-form navbar-left" role="search"
                                                action="<?php echo site_url('rekam_medis/pasien/laporan_pdf');?>"
                                                method="post">
                                        ...
                                        <div class="float-lg-right m-1">
                                            <form class="navbar-form navbar-left" role="search"
                                                action="<?php echo site_url('rekam_medis/pasien/laporan_pdf1');?>"
                                                method="post">
                                                <div class="form-group">
                                        ...
                                        <div class="float-lg-right m-1">
                                            <form class="navbar-form navbar-left" role="search"
                                                action="<?php echo site_url('rekam_medis/pasien/laporan_pdf2');?>"
                                                method="post">
                                                <div class="form-group">
                                                    <label for="tahun">Tahun</label>
                                                    <input
