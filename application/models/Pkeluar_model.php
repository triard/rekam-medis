...
class Pkeluar_model extends CI_Model
{
	...
	public function getKeluar(){
        $query = $this->db->query("SELECT DATE_FORMAT(tanggal_keluar, '%d/%m/%Y') as tanggal ,COUNT(id_pasien_keluar) AS jumlah FROM pasien_keluar GROUP BY DATE_FORMAT(tanggal_keluar, '%d/%m/%Y')");
	...
	public function getAllData()
	{
		...
		ps.keterangan_pasien,p.nama_pasien,p.no_KTP,p.tgl_lahir_pasien,nr.id_nomor_ruangan,nr.id_ruangan,nr.nomor_ruangan,
		nr.status_ruangan,r.id_ruangan,pk.status_pulang,r.nama_ruangan,p.id_pasien,l.nama,d.nama_penyakit,d.tindakan,d.nama_obat,pk.tanggal_keluar,pk.kondisi_keluar');
