...
class Diagnosa extends CI_Controller
{
	...
	public function list()
	{
		...
		$this->load->view("admin/diagnosa/list", $data);
	}
	...
	public function list_masuk()
	{
		...
		$this->load->view("admin/diagnosa/list_masuk", $data);
	}
	...
	public function add()
	{
		...
		if($validation->run()){
			...
			redirect(site_url('admin/diagnosa/list'),$data);
		}
	...
	{       
        ...
        if ($validation->run()) {
			...
			redirect(site_url('admin/diagnosa/list'));
		}
	...
	public function laporan_pdf(){
		...
		$this->pdf->load_view('admin/diagnosa/laporan_pdf', $data);	
	}
